"""
Multi-run vLLM inference for game_lie dataset.

Model: vLLM-served model (default meta-llama/Llama-3.1-70B-Instruct)
Dataset: probe_dataset.json (516 pairs, quiz league system prompts)
Temperature: 0.6
N_runs: 3
Output: game_lie_multi_results.json
"""
...
def main(model="meta-llama/Llama-3.1-70B-Instruct", base_url="http://localhost:8000/v1",
         dataset="probe_dataset.json", output="game_lie_multi_results.json",
